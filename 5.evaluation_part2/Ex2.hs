...
-- equal? has a bug in that a list of values is compared using eqv? instead of
-- equal?. For example, (equal? '(1 "2") '(1 2)) = #f, while you'd expect it to
-- be #t. Change equal? so that it continues to ignore types as it recurses
