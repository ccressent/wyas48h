...
-- For numbers, only number? is supported as I need to implement the full
-- numerical tower to define procedures like real?, complex?, ...
-- Some data type tests are missing (char?, vector?, procedure?, ...) as they
-- are not part (yet?) of LispVal.
